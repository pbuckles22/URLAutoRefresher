...
**Revision:** `.2` — dot-versioned handoff for calendar note **2026-04-14**. Do not overwrite **`.1`**; add **`.3`** when this content is superseded.
...
- **`.1`** — [HANDOFF-2026-04-14-next-agent.1.md](./HANDOFF-2026-04-14-next-agent.1.md) — gap-analysis / pre–Epic 3.2 handoff era (archived from git `8c90ebe`).
- **Index** — [HANDOFF-2026-04-14-next-agent.md](./HANDOFF-2026-04-14-next-agent.md) — lists **`.1`** / **`.2`** and points to the latest.
- **2026-04-15** — [HANDOFF-2026-04-15-next-agent.md](./HANDOFF-2026-04-15-next-agent.md) — separate dated snapshot (post–Epic **3.1**).
