...
- **Epic 5:** **5.1–5.4 done** — Shared UI [`src/dashboard/dashboard-app.ts`](src/dashboard/dashboard-app.ts) (dashboard + side panel); **Individual (M)** + browse grid; `Scripts/build.mjs` writes [`sidepanel/sidepanel.html`](sidepanel/sidepanel.html) from dashboard HTML (**creates `sidepanel/`** if missing); cross-surface buttons (`data-open-side-panel` / `data-open-dashboard-tab`); Tier 2 `e2e/epic-5.spec.ts`.
- **Next:** Epic **6** — focus-aware toolbar badge — [doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md).
- **Latest handoff:** [doc/handoff/HANDOFF-2026-04-14-next-agent.md](doc/handoff/HANDOFF-2026-04-14-next-agent.md) (index). **Current baseline:** [doc/handoff/HANDOFF-2026-04-14-next-agent.9.md](doc/handoff/HANDOFF-2026-04-14-next-agent.9.md) (build mkdir for `sidepanel/`; full **Epic 5** detail in [`.8`](doc/handoff/HANDOFF-2026-04-14-next-agent.8.md)), **`Last updated:` 2026-04-14**. Older dot revisions and the separate **2026-04-15** snapshot remain in `doc/handoff/` without overwriting.
