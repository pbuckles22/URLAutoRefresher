...
- **Epic 11:** **11.1–11.2, 11.4–11.7 done** — see EDGE [Epic 11](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md#epic-11--precision-volume-web-audio). **11.3** optional **L113** (**G3** still applies to hot files).
...
- **[Epic 11](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md#epic-11--precision-volume-web-audio):** **11.5–11.7 shipped** — dashboard/side panel controls, shortcut OSD, Vitest + Playwright regression for OSD; **11.3** per **L113** when staffed — still **one PR at a time** on hot paths (**G3**). Requirements: [doc/requirements/precision-volume-controller.md](doc/requirements/precision-volume-controller.md).
