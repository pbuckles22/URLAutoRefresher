...
- **Epic 12:** In plan — TwitchFavs / URL-first **docs**, **manual QA**, **requirements TF.6**, **CI-safe Playwright** ([Epic 12](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md#epic-12--twitchfavs--url-first-qa--ci-confidence)).
...
- **[Epic 12](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md#epic-12--twitchfavs--url-first-qa--ci-confidence):** **12.1–12.3** docs + manual + TF.6; **12.4** CI-safe Twitch coverage (route mock / Vitest / optional gated live spec).
