...
- **[Epic 11](doc/plan/EDGE_URL_AUTO_REFRESHER_PLAN.md#epic-11--precision-volume-web-audio):** **11.3** per **L113** when staffed; **11.4–11.7** unblocked now that **Epic 13.B** is complete (**G2**) — still **one PR at a time** on hot paths (**G3**). Requirements: [doc/requirements/precision-volume-controller.md](doc/requirements/precision-volume-controller.md).
